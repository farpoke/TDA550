 ...
 * Thereafter it is possible to move all forms to the upper
		 ...
		 pointSet.add(p); // just in order to check hashCode !!
	         ...
	         JOptionPane.showMessageDialog( this,  "A new random thick point is created" );
	          ...
	          JOptionPane.showMessageDialog( this,  "A new random line is created." );
                  ...
                  JOptionPane.showMessageDialog( this,  "Line: Form with this size already exists, try again" );
          }
          else if ( e.getSource() == square ) {
	      int length = Integer.parseInt(
			    JOptionPane.showInputDialog("Choose side length (1-500):")); 
	      if ( ! forms.add( new Square( x, y, length, c )) )
                 JOptionPane.showMessageDialog( this,  "Square: Form with this size already exists, try again" );
          }
	      ...
	      if ( ! forms.add( new Rectangle( x, y, width, heigth, c )) )
                 JOptionPane.showMessageDialog( this,  "Rectangle: Form with this size already exists, try again" );
	      ...
	      int radius = Integer.parseInt(
              ...
              if ( ! forms.add( new Circle( x, y, radius, c )  ) )
                 JOptionPane.showMessageDialog( this,  "Circle: Form with this size already exists, try again" );
          }
	      ...
	      if ( ! forms.add( new Oval( x, y, width, heigth, c )) )
                 JOptionPane.showMessageDialog( this,  "Oval: Form with this size already exists, try again" );

...
public class SnakeModel extends GameModel {
	...
	private static final GameTile TAIL_TILE = new RoundTile(Color.BLACK, Color.BLACK, 2.0);
	...
	private int score;
	private ArrayList<Position> tailPos = new ArrayList<Position>();
	...
	private void addTail() {
		...
		tailPos.add(tailPos.size() + 1, new Position(0, 0));
	}
